...
@Component({
  ...
  templateUrl: './consumerspending.component.html',
  styleUrls: ['./consumerspending.component.scss']
})
export class ConsumerSpendingComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.isLoader = true;
    this.apiservice.getReportURL("ConsumerSpending").subscribe(res => {
      if (res != null && res !== '') {
